...
import ImportFile from './ImportLeaveFile';
import moment from 'moment';
import { DataFetch } from '../../services/DataFetch';
import config from '../../config/config';
const BEARER_TOKEN = localStorage.getItem("userData");

class LeaveUpload extends Component {
    constructor() {
        super();
        this.state = {
            events: []
    ...
    refreshEvent() {
        var url = config.API_URL + "/upload-leave-list";
    ...
    render() {
        ...
        return (
            <>
                <h4 className="font-16 pl-3">Leave Balance Import</h4>
