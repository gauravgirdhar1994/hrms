...
class AddUniversity extends Component {
    ...
    handleSubmit = () => {
        ...
        const apiUrl = config.API_URL+'/employee/info/add/education/'+this.state.empId;
    ...
    render() {
        ...
        const { degree, fieldsofstudy, instituteName, endYear, grade, educationalDetails, startYear} = this.state.form;
            ...
            <div>
                ...
                <Modal show={this.props.showAdd} {...this.props}>
                        ...
                        <fieldset>
                                ...
                                <label htmlFor="jobDetails" className="mb-0">Add Education Details</label>
                                <div className="row mb-3">
                                    <div className="col-lg-12">
                                        <textarea type="text" id="educationalDetails" name="educationalDetails" onChange={this.handleChange} defaultValue={this.state.form.educationalDetails}  placeholder="" className="form-control" required="" />
                                    </div>
                                </div>
                            </fieldset>
...
export default connect(mapStateToProps, {editData})(AddUniversity);
