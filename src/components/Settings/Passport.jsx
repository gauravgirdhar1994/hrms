...
class EducationAccess extends Component {
    ...
    refreshData = () => {
        ...
        axios.get(config.API_URL + '/employee/access/list/' + this.state.orgId+"/5?role="+this.props.roleId+"&for_other="+this.props.forOther, { headers: { Authorization: bearer } })
            .then(r => {
            ...
            <>
                ...
                <Card className="card d-block p-1 mb-4 shadow-sm">
                    <div className="d-flex justify-content-between  mb-4 ">
                        <h4 className="font-16 pl-3">Passport</h4>
